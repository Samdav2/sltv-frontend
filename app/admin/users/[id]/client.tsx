...
import { ArrowLeft, Save, User, Mail, Lock, Loader2, Trash2 } from "lucide-react";
...
export default function AdminUserDetailsClient({ userId }: { userId: string }) {
                            ...
                            <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    <div className="space-y-2">
                                        ...
                                        <div className="relative">
                                            ...
                                            <Input {...register("full_name")} className="pl-10" placeholder="John Doe" />
                                        </div>
                                    ...
                                    <div className="space-y-2">
                                        ...
                                        <div className="relative">
                                            ...
                                            <Input {...register("email")} className="pl-10" placeholder="john@example.com" />
                                        </div>
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-3 gap-4 pt-4">
                                    <div className="flex items-center justify-between p-4 bg-gray-50 rounded-lg border border-gray-100">
                                        ...
                                        <input type="checkbox" className="w-4 h-4 text-red-600 rounded border-gray-300 focus:ring-red-500" {...register("is_active")} />
                                    </div>
                                    <div className="flex items-center justify-between p-4 bg-gray-50 rounded-lg border border-gray-100">
                                        <div className="space-y-0.5">
                                        ...
                                        <input type="checkbox" className="w-4 h-4 text-red-600 rounded border-gray-300 focus:ring-red-500" {...register("is_superuser")} />
                                    </div>
                                    <div className="flex items-center justify-between p-4 bg-gray-50 rounded-lg border border-gray-100">
                                        <div className="space-y-0.5">
                                        ...
                                        <input type="checkbox" className="w-4 h-4 text-red-600 rounded border-gray-300 focus:ring-red-500" {...register("is_verified")} />
                                    </div>
                                </div>
                ...
                <div className="space-y-6">
                    <Card>
                        ...
                        <CardContent className="space-y-4">
                            <Button variant="outline" className="w-full justify-start text-gray-700" onClick={handleResetPassword}>
